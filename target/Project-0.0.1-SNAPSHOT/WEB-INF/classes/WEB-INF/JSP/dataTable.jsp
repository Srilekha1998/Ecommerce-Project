...
<body>
  <form:form action="${pageContext.request.contextPath}/admin/addproduct" modelAttribute="product">
		<table class="table">
			<tr>
				<td>Product name:</td>
				<td><form:input type="text" name="productName" path="pname"/></td>
				<td><form:errors path = "pname"/></td>
			</tr>
			<tr>
				<td>Product Description:</td>
				<td><form:input type="text" name="productDesc" path="pdescription"/></td>
				<td><form:errors path = "pdescription"/></td>
			</tr>
			<tr>
				<td>Product Price:</td>
				<td><form:input type="text" name="productPrice" path="cost"/></td>
